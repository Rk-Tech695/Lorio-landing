...
const LandingHero = () => (
  <section id="hero" className="relative z-10 fleet-bg-gradient min-h-[80vh] flex items-center py-2 md:py-2">
    <div className="container mx-auto flex flex-col md:flex-row items-center justify-between gap-0 px-2">
      {/* Hero Content */}
            <div className="flex-1 text-white mb-4 md:mb-0 animate-fade-in-up">
                <div className="flex justify-between items-end mb-5 shadow-lg shadow-blue-900/20 rounded-2xl p-4  bg-opacity-20">
                    <img src="/assets/images/logo/logo-png-flet.png" className="w-20" alt="" />

                    <button onClick={() => window.location.href = "https://app.lorio.in"} className="bg-white text-lorio font-bold py-1 px-2 rounded-full hover:bg-blue-100 transition-colors text-[12px]">
                        Get Started
                    </button>
                </div>
        <h1 className="font-bold text-2xl md:text-5xl leading-tight mb-4 tracking-tight" style={{wordSpacing : "5px"}}>
          The App for modern <span className="text-orange">Fleet Owners</span>
        </h1>
      ...
      {/* Hero Image */}
      <div className="flex-1 flex justify-center items-center mt-6 md:mt-0 shadow-lg shadow-blue-900/20 rounded-2xl ">
