...
import { Award, Star, MapPin, Truck } from "lucide-react";
...
const LandingTestimonials = () => {
  ...
  const debounce = (fn, delay = 120) => {
    ...
    const applyWidthLogic = useCallback((w) => {
        // here in mobile view also I am getting w= 1280
    if (w >= 1024) {
      setSlidesToShow(3);
      setCenterMode(false);
    } else if (w >= 768) {
  ...
  useEffect(() => {
    ...
    console.log("slidesToShow:", slidesToShow, "centerMode:", centerMode);
    ...
    <section className="pt-10 pb-5 relative overflow-hidden" style={{ background: "linear-gradient(135deg, #f9fafb 0%, #f3f4f6 100%)" }}>
      <div className="container mx-auto px-4 max-w-7xl relative z-10">
        <div className="text-center mb-4 md:mb-12">
          ...
          <h2 className="text-2xl md:text-5xl font-bold mb-1 text-gray-800">
        ...
        <div className="testimonials-slider-container w-full overflow-visible">
          <div className="max-w-[95%] mx-auto">
            <Slider ref={sliderRef} {...sliderSettings}>
              {testimonials.map((t, index) => (
                <div key={index} className="px-0 py-0">
                  <div className="relative group h-full">
                      ...
                      <div className="mb-4">
                        <div className="w-10 h-10 rounded-lg flex items-center justify-center" style={{ background: t.iconColor }}>
                      ...
                      <blockquote className="text-gray-700 text-[12px] leading-relaxed mb-4 grow">"{t.quote}"</blockquote>
                      <div className="flex items-center gap-3 pt-3 border-t border-gray-200">
                        <div className="w-10 h-10 rounded-full flex items-center justify-center text-white font-bold text-sm shrink-0" style={{ background: t.iconColor }}>
                          {t.initials}
                        </div>
                        <div>
      ...
      {/* Custom slider styles removed. Use Tailwind and .slick CSS for layout. */}
    </section>
  );
};
