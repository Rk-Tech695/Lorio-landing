      ...
      <div className="max-w-7xl mx-auto w-full px-4 relative z-10">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <motion.div
              className="mt-12 bg-white/90 backdrop-blur-md rounded-2xl p-6 shadow-xl border-2"
            ...
            >
              <div className="grid grid-cols-5 gap-2 relative">
                ...
                >
                  ...
                  <div className="text-white text-xs font-bold px-2 py-1 rounded" style={{ backgroundColor: 'rgb(87, 8, 133)' }}>01</div>
                ...
                >
                  ...
                  <div className="text-white text-xs font-bold px-2 py-1 rounded" style={{ backgroundColor: 'rgb(87, 8, 133)' }}>02</div>
                ...
                >
                  ...
                  <div className="text-white text-xs font-bold px-2 py-1 rounded" style={{ backgroundColor: 'rgb(87, 8, 133)' }}>03</div>
                ...
                >
                  ...
                  <div className="text-white text-xs font-bold px-2 py-1 rounded" style={{ backgroundColor: 'rgb(87, 8, 133)' }}>04</div>
                ...
                >
                  ...
                  <div className="bg-green-600 text-white text-xs font-bold px-2 py-1 rounded">05</div>
